    ...
    <script>
        ...
        function sendChatMessage() {
            ...
            if (message !== '') {
                ...
                xhr.open('POST', '/HMS/dr/send_chat_message.php');
        ...
        function fetchChatMessages() {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('GET', `/HMS/dr/fetch_chat_messages.php?sender=${encodeURIComponent(sender)}&recipient=${encodeURIComponent(recipient)}&chatId=${encodeURIComponent(chatId)}`);

...
require_once 'header_after_dr.php';
?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="wallet-container">
        ...
        if (isset($_POST['withdraw_amount'])) {
            ...
            $canWithdraw = canWithdraw($connection, $balance, $did, $amount);
                    ...
                    if ($balance >= $amount) {
                        ...
                        if ($canWithdraw) {
                            ...
                            if ($stmt->execute()) {
                                ...
                                $stmt->bind_param("iis", $did, $amount, $remark);
                                $stmt->execute();

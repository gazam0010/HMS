...
<body>
            ...
            <div class="container main-nav flex">
                ...
                <div class="nav-links">
                    <ul class="flex">
                        ...
                        <li><a href="d_prediction.php" class="hover-link">Diabetes Prediction</a></li>
                        <li><a href="aa.php" class="hover-link">Appointments</a></li>
                        <li><a href="wallet.php" class="hover-link">Wallet</a></li>
                        <li><a href="login.php" class="hover-link">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <style>
        ...
        .nav-links li:not(:last-child)::after {
            content: '';
            position: absolute;
            right: -15px; /* Adjust the distance of the line from the link */
            top: 50%;
            transform: translateY(-50%);
            width: 1px;
            height: 20px; /* Adjust the height of the line */
            background-color: #ccc; /* Change the color to desired grey shade */
        }
    </style>
</body>

        ...
        <div class="top-banner">
            <div class="container">
                <div class="small-bold-text banner-text">
                    <h1>SMART HEALTH MONITORING SYSTEM<span class="small-text"> (for patients)</span></h1>
                </div>
            </div>
        </div>
            ...
            <div class="container main-nav flex">
                ...
                <div class="nav-links">
                    <ul class="flex">
                        ...
                        <li><a href="patientpanel.php" class="hover-link">Dashboard</a></li>
                        <li><a href="aa.php" class="hover-link">Appointments</a></li>
                        <li><a href="wallet.php" class="hover-link">Wallet</a></li>
                        <li><a href="prediction.php" class="hover-link">Diabetes Prediction</a></li>
                        <li><a href="p_changepsw.php" class="hover-link" target="_blank">Change Password</a></li>
                        <li><a href="p_logout.php" class="hover-link">Logout</a></li>
                    </ul>
                </div>
            </div>
        </nav>
